...
var Confetti = function () {
  function Confetti(param) {
    ...
    this.speedRange = typeof param.speedRange === "number" ? param.speedRange : 50;
    this.sprites = [];

    this.canvas.style.cssText = ["display: block","z-index:3", "position: absolute", "top: 0", "left: 0", "pointer-events: none"].join(";");
...
(function () {
  var DURATION = 50000,
      LENGTH = 120,
      HEIGHT = document.getElementById('app').height;
    setTimeout(function () { 
    new Confetti({
